...
//     private func icon(_ coordinate: Coordinate) -> String {
//         guard let cellValue = board.grid[coordinate] else {
//             return "🌊"
//         }
...
// final class MockBoard: Board {
//     var grid: [Coordinate: CellValue] = [:]
// }

// final class MockTrackingBoard: TrackingBoard {
//     var grid: [Coordinate: ShotResult] = [:]
// }
